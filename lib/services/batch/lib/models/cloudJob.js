 ...
 * 'terminating', 'completed', 'deleting', 'unmapped'
 * 
 ...
 * 
 * @member {string}
 * [poolInfo.autoPoolSpecification.pool.virtualMachineConfiguration.nodeAgentSKU]
 ...
 * (in GiB) of I/O read by all the tasks in the job.
 * 
    ...
    type: {
      ...
      modelProperties: {
        ...
        state: {
          ...
          type: {
            name: 'Enum',
            allowedValues: [ 'active', 'disabling', 'disabled', 'enabling', 'terminating', 'completed', 'deleting', 'unmapped' ]
          }
        },
        stateTransitionTime: {
          required: false,
