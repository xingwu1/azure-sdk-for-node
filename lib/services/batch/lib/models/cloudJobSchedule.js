 ...
 * 
 * @member {string}
 * [jobSpecification.poolInfo.autoPoolSpecification.pool.virtualMachineConfiguration.nodeAgentSKU]
 ...
 * the schedule.
 * 
 * @member {number} [stats.readIOGiB] Gets or sets the total amount of data
 * (in GiB) of I/O read by all the tasks in all the jobs created under the
 * schedule.
 * 
    ...
    type: {
      ...
      modelProperties: {
        ...
        state: {
          ...
          type: {
            name: 'Enum',
            allowedValues: [ 'active', 'completed', 'disabled', 'terminating', 'deleting', 'unmapped' ]
          }
        },
        stateTransitionTime: {
          required: false,
