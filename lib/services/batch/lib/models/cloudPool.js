 ...
 * Possible values include: 'active', 'deleting', 'upgrading', 'unmapped'
 * 
 ...
 * 
 * @member {string} [virtualMachineConfiguration.nodeAgentSKU] Gets or sets
    ...
    type: {
      ...
      modelProperties: {
        ...
        state: {
          ...
          type: {
            name: 'Enum',
            allowedValues: [ 'active', 'deleting', 'upgrading', 'unmapped' ]
          }
        },
        stateTransitionTime: {
          required: false,
        ...
        allocationState: {
          ...
          type: {
            name: 'Enum',
            allowedValues: [ 'steady', 'resizing', 'stopping', 'unmapped' ]
          }
        },
