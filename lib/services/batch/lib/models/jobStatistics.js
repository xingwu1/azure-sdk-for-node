 ...
 * of I/O read by all the tasks in the job.
 * 
 * @member {number} [writeIOGiB] Gets or sets the total amount of data (in
 * GiB) of I/O written by all the tasks in the job.
 * 
 ...
 * on all the tasks in the job during the given time range.
 * 
 * @member {moment.duration} [waitTime] Gets or sets the total wait time of
 * all the tasks in the job.  The wait time for a task is defined as the
