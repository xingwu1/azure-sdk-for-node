 ...
 *                      See {@link AccountListPoolUsageMetricsResult} for more
 *                      information.
 *
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['AccountListPoolUsageMetricsResult']().mapper();
 ...
 * 
 * @param {string} [pool.virtualMachineConfiguration.nodeAgentSKU] Gets or
...
Pool.prototype.evaluateAutoScale = function (poolId, autoScaleFormula, options, callback) {
  ...
  try {
    ...
    {
      poolEvaluateAutoScaleParameter = new client.models['PoolEvaluateAutoScaleParameter']();
...
Pool.prototype.upgradeOS = function (poolId, targetOSVersion, options, callback) {
  ...
  try {
    ...
    {
      poolUpgradeOSParameter = new client.models['PoolUpgradeOSParameter']();
