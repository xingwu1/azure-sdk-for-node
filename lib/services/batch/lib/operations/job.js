 ...
 * operation
 * 
 * @param {string} [options.jobGetOptions.$select] Sets an OData $select
 * clause.
 * 
 * @param {string} [options.jobGetOptions.$expand] Sets an OData $expand
 * clause.
 * 
 ...
 * 
 * @param {string}
 * [jobPatchParameter.poolInfo.autoPoolSpecification.pool.virtualMachineConfiguration.nodeAgentSKU]
 ...
 * 
 * @param {string}
 * [jobUpdateParameter.poolInfo.autoPoolSpecification.pool.virtualMachineConfiguration.nodeAgentSKU]
 * Gets or sets the SKU of Batch Node Agent that needs to be provisioned on
 * the compute node. This property must match the ImageReference property.
 * 
 * @param {object}
...
Job.prototype.disable = function (jobId, disableTasks, options, callback) {
  ...
  try {
    ...
    {
      jobDisableParameter = new client.models['JobDisableParameter']();
 ...
 * 
 * @param {string}
 * [job.poolInfo.autoPoolSpecification.pool.virtualMachineConfiguration.nodeAgentSKU]
 * Gets or sets the SKU of Batch Node Agent that needs to be provisioned on
 * the compute node. This property must match the ImageReference property.
 * 
 * @param {object}
