 ...
 * 
 * @param {string} [options.format] Gets or sets the format of the application
 * package binary file.
 * 
 ...
 */
ApplicationOperations.prototype.activateApplicationPackage = function (resourceGroupName, accountName, id, version, options, callback) {
 ...
 * 
 * @param {boolean} [parameters.allowUpdates] Gets or sets whether packages
 * within the application may be overwritten using the same version string.
 * 
 * @param {string} [parameters.displayName] Gets or sets the display name for
 * the application.
 * 
 * @param {object} [options] Optional Parameters.
 * 
 ...
 * @param {object} [options] Optional Parameters.
 * 
 * @param {number} [options.maxresults] Gets or sets the maximum number of
