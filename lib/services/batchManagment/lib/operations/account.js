 ...
 * 
 * @param {object} [parameters.properties.autoStorage] Gets or sets properties
 * relating to auto storage.
 * 
 * @param {string} [parameters.properties.autoStorage.storageAccountId] Gets
 * or sets the resource id of the storage account to be used for auto storage.
 * 
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.listActions = function (options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var requestUrl = this.client.baseUri +
                   '//subscriptions/{subscriptionId}/providers/Microsoft.Batch/actions';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  var queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'AccountActionsElementType',
                  type: {
                    name: 'Composite',
 ...
 * the specified resource group.
 *
 * @param {string} resourceGroupName An optional argument which specifies the
 * name of the resource group that constrains the set of accounts that are
 * returned.
 * 
 * @param {object} [options] Optional Parameters.
 * 
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.list = function (resourceGroupName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 * @param {object} [options] Optional Parameters.
 * 
 * @param {string} [options.keyName] The type of account key to regenerate.
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.regenerateKey = function (resourceGroupName, accountName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
